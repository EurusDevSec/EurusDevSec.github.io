      ...
      <form action={action} className="space-y-4">
        ...
        <div>
          <label htmlFor="username" className="mb-1.5 block text-sm font-medium text-text-secondary">
            Username <span className="text-xs text-text-muted">(chỉ a-z, 0-9, _, -)</span>
          </label>
          <input
            id="username"
            name="username"
        ...
        <div>
          <label htmlFor="display_name" className="mb-1.5 block text-sm font-medium text-text-secondary">
            Tên hiển thị <span className="text-xs text-text-muted">(tùy chọn)</span>
          </label>
          <input
            id="display_name"
            name="display_name"
        ...
        <div>
          <label htmlFor="password" className="mb-1.5 block text-sm font-medium text-text-secondary">
            Mật khẩu <span className="text-xs text-text-muted">(ít nhất 6 ký tự)</span>
          </label>
          <input
            id="password"
            name="password"
