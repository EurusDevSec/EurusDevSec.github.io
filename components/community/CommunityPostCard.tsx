...
export default function CommunityPostCard({ post }: { post: CommunityPost }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col gap-3 rounded-xl border border-border/60 bg-surface/60 p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-secondary/30 hover:shadow-[0_0_25px_hsl(258_90%_73%/0.08)]"
    >
