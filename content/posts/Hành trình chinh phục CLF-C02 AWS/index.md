---
title: Hành Trình Chinh Phục CLF-C02 AWS Cert đầu tiên của tôi
date: 2026-04-04
tags:
  - Learn
  - guide
...
# Lợi ích của chứng chỉ AWS CLF-C02

## Đây là chứng chỉ khi bạn pass

![Credly AWS Cloud](Credly_aws_cloud.png)
![AWS CLF-C02 Certificate](cert_aws.png)
...
## Lợi ích của các Cert

- **Lợi ích đầu tiên:** Nó là điểm khởi đầu cho những cert quan trọng sau này. Nếu bạn pass `CLF-C02` bạn sẽ được voucher giảm giá `50%` cho Cert tiếp theo.
- **Lợi ích thứ 2:** Giúp bạn tăng tự tin về nền tảng Cloud, nơi bắt đầu tất cả về hệ sinh thái đám mây. Việc này giúp bạn trong mọi lĩnh vực ngành nghề phổ biến tại `Việt Nam` như Dev, AI, IoT, Big Data hoặc các ngành khác như marketing, HR, tư vấn về cloud.
- **Lợi ích thứ 3:** Kiến thức nền tảng để học lên các Cert cao hơn như `AWS SAA-C03`, `AWS DVA`, ... còn rất nhiều Cert cấp cao khác.

## Danh sách 12 Cert chính của AWS

![12 AWS Certifications](12_cert.png)

# Nội dung thi chứng chỉ AWS CLF-C02
...
- Chi phí thi: `100$`. Tuy nhiên có vài cách để bạn có thể mua từ bên thứ 3 với giá rẻ hơn. Mình đã mua từ shop này khá uy tín, bạn có thể tham khảo, giá còn tầm `900k`. Vì đây là voucher giảm giá 100% nên yên tâm hơn so với các voucher 50% (có thể bị `AWS` quét).
  - [AWS Cert Discount Group](https://www.facebook.com/groups/1204797124657101)
    ![AWS Voucher](aws_voucher.png)
...
Về cơ bản bạn không cần phải học ở quá nhiều nguồn. Tôi chỉ học ở một nơi duy nhất là khoá học của `AWS`. Nhiều người sẽ học theo `Udemy`, việc này hoàn toàn ổn, nhưng bạn sẽ tốn một khoản vài trăm nghìn không cần thiết trong khi `AWS` là quá đủ để học.

Cụ thể mình để nguồn ở đây:  
...
![Cloud Practitioner Essentials](cloud_practioner_essential.png)
...
Luyện trên này là quá đủ vì câu hỏi khi thi khá sát. Nếu bạn luyện đề ở đây đạt tầm 90-95% trở lên thì bạn dư sức `pass` Cert này.

![ExamPrepper](examppreper.png)

### Kananirav Practice Exam

Nguồn thứ 2 tôi luyện của anh `Ấn Độ` này cũng rất bao quát để yên tâm hơn.

[Kananirav Practice Exam](https://kananinirav.com/practice-exam/exams.html)
![Kananirav Practice](karaninirav_practice.png)
...
[Jaspal AWS CLF-C02 Course](https://youtu.be/yChiWUxP_2M?si=uB24Am43xq0v4SBv)
![Jaspal Practice](Jaspal_practice.png)
...
![Map to Pearson VUE](map_to_pearson_vue.png)
...
![Pearson VUE Test Center](more_test_center.png)

## Review chỗ thi

![Floor 3 Entrance](location_floor3_entrance.png)
![CHEK Floor 3](floor3_chek.png)
...
(Bạn có thể bỏ qua phần này nếu muốn)

## Hành trình chinh phục Cert đầu tiên
...
## Over Prepared (chuẩn bị quá mức)

Khi thi xong tôi mới nhận ra đề này dễ hơn tôi tưởng. Trước đó tôi luôn cảm thấy mình có thể `Fail` nên luyện đề gần như hết công suất vì sợ rớt; hầu như ngày nào trước khi thi tôi cũng `Stress`. Tôi rút ra bài học là không nên tưởng tượng quá mức một thứ gì đó quá khó trước khi nó xảy ra.

### Bài học từ hành trình này:

- Hãy bình tĩnh, có sự chuẩn bị chắc chắn
