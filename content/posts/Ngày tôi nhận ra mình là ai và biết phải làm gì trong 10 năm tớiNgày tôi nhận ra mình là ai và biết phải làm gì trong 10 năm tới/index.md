...
> **Lý do:**
>
> 1. `khoảng cách` vì từ nhá tôi đến Bitexco(nơi diễn ra `hội thảo` ở tầng 26) đén đó đi khá xa mất khoảng 1 tiếng, nắng nôi, kẹt xe,...blah blah
...
> 3. Ngày `21/03/2026` buồi sáng tôi có môn báo cáo cuối kì môn `Machine Learning` (học máy) và may thay tôi có phương án dự phòng được teamate gánh hết nên khá đỡ phần này, nhưng cái tôi của tôi lại dùng lý do có môn báo cáo này để chỉ để biện minh nỗi sợ của mình

![](bitexco_tower.jpg)

## 2. Sự thức tỉnh trong giấc ngủ

Vào đêm trước đó tôi thật sự khó ngủ và hầu như không thể ngủ được, cứ có việc quan trọng vào buổi sáng tiếp theo là tôi lại khó ngủ vào buổi tối, dù tôi là thằng bình thường dễ ngủ
...
Tôi chuẩn bị mọi thứ hành trang và giao việc báo cáo cho teamate của tôi với sự tôn trọng
...
**2. Thứ hai là:** khi mà AI ngày càng mạnh về technical và trong một dev team mà ai cũng có cái `technical` như nhau vậy cái vấn đề năng lực khác nhau ở chỗ nào -> Anh `Hưng` mới nói một điều mà tôi đã nghe nhiều lần từ ba tôi là `soft skill` là các skills về con người như giao tiếp, thấu hiểu, kết nối với những người khác, cởi mở, chủ động, mạnh dạn, phải biết phối hợp với người khác để cùng giải quyết vấn đề

**3. Thứ ba là:** biết 100 cái `Tools` khác nhau cũng không quan trọng, mà cái quan trọng là phải hiểu rõ cái bản chất cái nền tảng cơ bản nhất

Ví dụ Khi AWS EKS gặp lỗi thì cần phải `troubeshooting` nó nhưng để `troubleshooting` được thì phải nắm chắc thằng `kubernetes` bởi vì công cụ nào đi nữa nó cũng quy về một cái kiến thức căn bản nhất
...
Backend hay AI Engineer, bản chất AI engineer cũng từ Backend mà ra mà bây giờ doanh nghiệp đòi hỏi kĩ năng rất nhiều người mới chứ không chỉ từng lĩnh vực như hồi xưa (chú ý `data platform cho devops nếu chỉ biết mỗi devops thì không thể làm được gì`)
